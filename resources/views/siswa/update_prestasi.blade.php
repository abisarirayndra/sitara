    ...
    <div class="content">
      <div class="container">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('update_prestasi', [$prestasi->id]) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                              <div class="card-body">
                                <div class="text-center">
                                    <video src="{{ asset('files/'. $item->file) }}" autoplay="false" controls width="200" height="200" loop="false"></video>
                                </div>
                                <div class="text-center">
                                    <p>{{ $item->file }}</p>
                                    <p>{{ $item->jenis }}</p>
