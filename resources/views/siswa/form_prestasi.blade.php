                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="tingkat" placeholder="Exp: Keresidenan Besuki">
                          </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="input-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_kejuaraan" placeholder="Exp: Olimpiade Fisika">
                          </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="penyelenggara" placeholder="Exp: Pemprov. Jatim">
                          </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nomor_piagam" placeholder="Exp: 22/XI/2022">
                          </div>
                        </div>
                    </div>
                    <div class="row">
