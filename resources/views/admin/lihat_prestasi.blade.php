        ...
        <div class="card">
            ...
            <div class="card-body">
                <table>
                    <tr>
                        <td><b>Nama</b></td>
                        <td class="pl-4">{{$siswa->nama}}</td>
                    </tr>
                    <tr>
                        <td><b>Kelas</b></td>
                        <td class="pl-4">{{$siswa->kelas}}</td>
                    </tr>
                    <tr>
                        <td><b>Prestasi</b></td>
                        <td class="pl-4">{{$prestasi->jenis}}</td>
                    </tr>
                    <tr>
                        <td><b>Tingkat</b></td>
                        @if ($prestasi->tingkat == 1)
                        <td class="pl-4">Nasional {{ $prestasi>wilayah }}</td>
                        @elseif ($prestasi->tingkat == 2)
                        <td class="pl-4">Provinsi {{ $prestasi->wilayah }}</td>
                        @elseif ($prestasi->tingkat == 3)
                        <td class="pl-4">Keresidenan {{ $prestasi->wilayah }}</td>
                        @elseif ($prestasi->tingkat == 4)
                        <td class="pl-4">Kabupaten {{ $prestasi->wilayah }}</td>
                        @endif
                    </tr>
                    <tr>
                        <td><b>Juara</b></td>
                        <td class="pl-4">{{$prestasi->juara}}</td>
                    </tr>
                    <tr>
                        <td><b>Kejuaraan</b></td>
                        <td class="pl-4">{{$prestasi->nama_kejuaraan}}</td>
                    </tr>
                    <tr>
                        <td><b>Penyelenggara</b></td>
                        <td class="pl-4">{{ $prestasi->penyelenggara }}</td>
                    </tr>
                    <tr>
                        <td><b>Nomor Piagam</b></td>
                        <td class="pl-4">{{ $prestasi->nomor_piagam }}</td>
                    </tr>
                    <tr>
                        <td><b>Tanggal Piagam</b></td>
                        <td class="pl-4">{{ $prestasi->tanggal }}</td>
                    </tr>
                    <tr>
                        <td><b>Tempat Pelaksanaan</b></td>
                        <td class="pl-4">{{ $prestasi->tempat_pelaksanaan }}</td>
                    </tr>
                </table>
                <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                              <div class="card-body">
                                <div class="text-center">
                                    <video src="{{ asset('files/'. $item->file) }}" controls autoplay="false" width="200" height="200" loop="false"></video>
                                </div>
                                <div class="text-center">
                                    <p>{{ $item->file }}</p>
                                    <p>{{ $item->jenis }}</p>
