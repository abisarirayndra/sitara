        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-right">
                    <a href="{{ route('admin.kelas') }}" class="btn btn-sm btn-danger"><i class="fas fa-times"></i></a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $item->nama }}</td>
                        <td>{{ $item->kelas }}</td>
                        <td><a href="{{ route('admin.daftar_prestasi', [$item->id]) }}" class="btn btn-sm btn-primary"><i class="fas fa-pen"></i> Pilih</a></td>
                    </tr>
                    @endforeach
